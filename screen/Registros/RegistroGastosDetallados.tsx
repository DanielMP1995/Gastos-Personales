    ...
    function guardarPagoDetallado() {
        ...
        get(usuarioRef).then((snapshot) => {
            if (snapshot.exists()) {
                ...
                if (tipoGasto === 'deuda') {
                    const nombreEntidad = deudaSeleccionada
                        ? (
    ...
    return (
        ...
        >
            ...
            <Text style={styles.subtitulo}>
                Registra pagos a deudas o servicios fijos
                descontando de tu balance.
            </Text>
            ...
            <View style={styles.tipoContainer}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => {
                        setTipoGasto('deuda');
                        setSubCategoria('Tarjeta de Crédito');
                ...
                <View style={styles.seccionDeudasBox}>
                    ...
                    {deudasFiltradas.length === 0 ? (
                        <Text style={styles.avisoTexto}>
                            No hay deudas registradas bajo
                            esta categoría exacta.
                        </Text>
                    ) : (
            ...
            {tipoGasto === 'fijo' && (
                <View style={styles.seccionDeudasBox}>
                    ...
                    <Text style={styles.labelBox}>
                        Servicios fijos registrados en
                        "{subCategoria}":
                    </Text>
